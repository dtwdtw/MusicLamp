...
public class LocalControlBottonSheet extends Dialog implements DialogInterface {
    ...
    public LocalControlBottonSheet(Context context, MyApplication myApplication, boolean isLocal) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View sheetView = LayoutInflater.from(context).inflate(R.layout.localsheetplaytingcontrol, null, false);
        if (myApplication.isLocalDevicesPlaying()) {
            ...
            ((SeekBar) sheetView.findViewById(R.id.seekbarvolum)).setProgress(preferences.getInt("volume", 0));
        }
