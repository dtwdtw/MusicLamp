...
public class WifiAdmin {
    ...
    public int getWifiFrequency() {
        ...
        for(ScanResult scanResult:scanResults){
            Log.v("wifistate",scanResult.SSID);
            Log.v("wifistate",scanResult.frequency+"");
            Log.v("wifistate",getWifiSSID());
            if((scanResult.SSID).equals(getWifiSSID().replace("\"",""))){
