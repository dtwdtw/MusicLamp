...
public class LocalPlayingListAdapter extends BaseAdapter {
    ...
    public LocalPlayingListAdapter(Context context, MyApplication myApplication) {
        this.context = context;
        this.musicInfos = myApplication.getLocalMusicInfos();
