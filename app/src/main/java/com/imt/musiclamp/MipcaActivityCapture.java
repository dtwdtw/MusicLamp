...
public class MipcaActivityCapture extends Activity implements Callback, View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        loveID = (Button) findViewById(R.id.buttonloveID);
        ImageButton mButtonBack = (ImageButton) findViewById(R.id.button_back);
        mButtonBack.setOnClickListener(this);
        hasSurface = false;
        inactivityTimer = new InactivityTimer(this);
        Bundle bundle=getIntent().getExtras();
        if(bundle!=null&&bundle.containsKey("myLove")) {
            mylove = bundle.getBoolean("myLove");
        }
        ...
        Button mImageButton = (Button) findViewById(R.id.button_function);
        mImageButton.setOnClickListener(this);
        loveID.setOnClickListener(this);
...
//        shraed = getSharedPreferences("history", 0);
//        String name = shraed.getString("name", "kool");
//        shraed.edit().putString("name", "yang").commit();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button_function:
                ...
                Intent wrapperIntent = Intent.createChooser(innerIntent, getResources().getString(R.string.select_image));
                this.startActivityForResult(wrapperIntent, REQUEST_CODE);
                break;
            case R.id.buttonloveID:
                final AlertDialog.Builder builder = new AlertDialog.Builder(MipcaActivityCapture.this);
                builder.setTitle(getResources().getString(R.string.enter_frinefd_id));
                editText = new EditText(MipcaActivityCapture.this);
    ...
    class upPeople implements Runnable {
        ...
        @Override
        public void run() {
            ListView listView = new ListView(MipcaActivityCapture.this);
            ...
            builder1.setNegativeButton(getResources().getString(R.string.previous_page), new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    if (position > 9) {
                        ...
                        Toast.makeText(MipcaActivityCapture.this, R.string.last_page, Toast.LENGTH_SHORT).show();
                        flash();
                    }
                }
            });
                ...
                new UserServer(handler, new StringURL(StringURL.addFriend).setFriendID(listPeople.get(position).getFriendID()).setUserID(((MyApplication) getApplication()).userID).setFriendType("1").toString()) {
                    ...
                    public void httpBack(JSONObject jsonObject) {
                        if (StrUrl.getResult(jsonObject).equals("1")) {
                            Toast.makeText(MipcaActivityCapture.this, R.string.request_has_been_sent, Toast.LENGTH_SHORT).show();
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            new getImg(new Handler(),jsonArray.getJSONObject(finalI).getString("headIconURL")) {
                                ...
                                public void bitMapBack(Bitmap bitmap) {
                                    try {
                                        Friend friend = new Friend(MipcaActivityCapture.this, bitmap, jsonArray.getJSONObject(finalI).getString("nickName"), jsonArray.getJSONObject(finalI).getString("sex"), "Translate the word!", jsonArray.getJSONObject(finalI).getString("userID"));
